...
export const Route = createFileRoute("/browse")({ beforeLoad: requireReader, head: () => ({ meta: [{ title: "Browse books — Athenaeum" }, { name: "description", content: "Search books by genre, rating, and recommendation." }, { property: "og:title", content: "Browse books — Athenaeum" }, { property: "og:description", content: "Search books by genre, rating, and recommendation." }, { property: "og:type", content: "website" }, { name: "twitter:card", content: "summary" }] }), component: BrowsePage });
